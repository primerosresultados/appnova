...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen h-screen w-full flex items-center justify-center bg-background p-4 overflow-hidden relative">
            ...
            <Card className="w-full max-w-md shadow-2xl border-border/20 bg-card backdrop-blur-xl relative z-10 transition-all hover:shadow-primary/5">
